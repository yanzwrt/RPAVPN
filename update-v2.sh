...
if [[ -e /usr/local/bin/xray ]]; then
	 ...
	 wget -O add-tr "https://raw.githubusercontent.com/yanzwrt/RPAVPN/main/XRAY/add-tr.sh" && chmod +x add-tr
	 wget -O add-vless "https://raw.githubusercontent.com/yanzwrt/RPAVPN/main/XRAY/add-vless.sh" && chmod +x add-vless
	 wget -O add-ws "https://raw.githubusercontent.com/yanzwrt/RPAVPN/main/XRAY/add-ws.sh" && chmod +x add-ws
	 wget -O user-tr "https://raw.githubusercontent.com/yanzwrt/RPAVPN/main/XRAY/user-tr.sh" && chmod +x user-tr
	 wget -O user-vless "https://raw.githubusercontent.com/yanzwrt/RPAVPN/main/XRAY/user-vless.sh" && chmod +x user-vless
