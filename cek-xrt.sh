...
LOG_FILE="/var/log/xray/access5.log"

clear
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "\\E[0;47;30m Pengguna Login XRAY TROJAN XTLS  \E[0m"
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
if [[ ${#online_users[@]} -eq 0 ]]; then
  echo -e " ${yellow}Belum ada user TROJAN XTLS yang tercatat login.${NC}"
  echo ""
  read -n1 -s -r -p "Press [ Enter ] kembali ke menu . . . "
  menu
  exit 0
...
echo ""
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e " ${green}Selesai menampilkan login XRAY TROJAN XTLS.${NC}"
echo ""
read -n1 -s -r -p "Press [ Enter ] kembali ke menu . . . "
menu
