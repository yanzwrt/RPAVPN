...
LOG_FILE="/var/log/xray/access4.log"

clear
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "\\E[0;47;30m  Pengguna Login XRAY TROJAN TCP  \E[0m"
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
if [[ ${#online_users[@]} -eq 0 ]]; then
  echo -e " ${yellow}Belum ada user TROJAN TCP yang tercatat login.${NC}"
  echo ""
  read -n1 -s -r -p "Press [ Enter ] kembali ke menu . . . "
  menu
  exit 0
...
echo ""
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e " ${green}Selesai menampilkan login XRAY TROJAN TCP.${NC}"
echo ""
read -n1 -s -r -p "Press [ Enter ] kembali ke menu . . . "
menu
